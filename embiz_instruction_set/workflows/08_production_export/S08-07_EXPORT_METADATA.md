# #S08-07_EXPORT_METADATA — Export Production Metadata
...
## OBJECTIVES
- IMMEDIATE OBJECTIVE: Attach production metadata to exports.
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/S08-07_EXPORT_METADATA.json  (schema: contracts/evidence_schema.json)
...
- HASH: `python3 engine/hash_chain.py --append '#S08-07_EXPORT_METADATA' evidence/S08-07_EXPORT_METADATA.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/S08-07_EXPORT_METADATA.json? (answer YES or NO)
- Q2 (mandatory): Do the results satisfying the immediate objective classify as a SUCCESS? (answer YES or NO)
- Q3: Was production metadata attached to exports? (answer YES or NO)
...
7. Produce the hashed evidence artifact at evidence/S08-07_EXPORT_METADATA.json.
...
10. State exactly which step, file, and folder you will proceed to based on the
    ...
    `python3 engine/supervisor.py --resolve '#S08-07_EXPORT_METADATA' --classification <SUCCESS|FAILURE>`
