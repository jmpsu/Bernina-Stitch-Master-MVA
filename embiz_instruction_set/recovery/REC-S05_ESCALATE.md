# #REC-S05_ESCALATE — Recovery: Escalate with Prescribed External Research
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S05_ESCALATE
- FILE: recovery/REC-S05_ESCALATE.md
- SECTION: S05 recovery — Vector Validation & Ranking
- ON SUCCESS →: #REC-S05_DIAGNOSE @ recovery/REC-S05_DIAGNOSE.md
- ON FAILURE →: #REC-S05_DIAGNOSE @ recovery/REC-S05_DIAGNOSE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S05_ESCALATE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S05_ESCALATE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S05_ESCALATE' evidence/REC-S05_ESCALATE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S05_ESCALATE.json?
...
1. State this step id: #REC-S05_ESCALATE.
2. State the SUCCESS route (#REC-S05_DIAGNOSE).
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S05_ESCALATE' --classification <SUCCESS|FAILURE>`
