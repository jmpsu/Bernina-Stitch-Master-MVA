# #REC-S05_DIAGNOSE — Recovery: Diagnose the Failure
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S05_DIAGNOSE
- FILE: recovery/REC-S05_DIAGNOSE.md
- SECTION: S05 recovery — Vector Validation & Ranking
- ON SUCCESS →: #REC-S05_REPAIR @ recovery/REC-S05_REPAIR.md
- ON FAILURE →: #REC-S05_ESCALATE @ recovery/REC-S05_ESCALATE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S05_DIAGNOSE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S05_DIAGNOSE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S05_DIAGNOSE' evidence/REC-S05_DIAGNOSE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S05_DIAGNOSE.json?
...
1. State this step id: #REC-S05_DIAGNOSE.
2. State the SUCCESS route (#REC-S05_REPAIR).
3. State the FAILURE route: #REC-S05_ESCALATE @ recovery/REC-S05_ESCALATE.md.
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S05_DIAGNOSE' --classification <SUCCESS|FAILURE>`
