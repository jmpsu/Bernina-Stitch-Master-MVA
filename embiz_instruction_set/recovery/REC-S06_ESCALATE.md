# #REC-S06_ESCALATE — Recovery: Escalate with Prescribed External Research
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S06_ESCALATE
- FILE: recovery/REC-S06_ESCALATE.md
- SECTION: S06 recovery — Embroidery Digitization / Stitch Planning
- ON SUCCESS →: #REC-S06_DIAGNOSE @ recovery/REC-S06_DIAGNOSE.md
- ON FAILURE →: #REC-S06_DIAGNOSE @ recovery/REC-S06_DIAGNOSE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S06_ESCALATE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S06_ESCALATE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S06_ESCALATE' evidence/REC-S06_ESCALATE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S06_ESCALATE.json?
...
1. State this step id: #REC-S06_ESCALATE.
2. State the SUCCESS route (#REC-S06_DIAGNOSE).
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S06_ESCALATE' --classification <SUCCESS|FAILURE>`
