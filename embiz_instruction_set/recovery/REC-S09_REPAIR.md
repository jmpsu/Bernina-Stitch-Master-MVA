...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S09_REPAIR.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S09_REPAIR' evidence/REC-S09_REPAIR.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S09_REPAIR.json?
...
1. State this step id: #REC-S09_REPAIR.
2. State the SUCCESS route (#REC-S09_VERIFY).
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S09_REPAIR' --classification <SUCCESS|FAILURE>`
