# #REC-S01_VERIFY — Recovery: Verify the Repair Produced Real Working Behavior
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S01_VERIFY
- FILE: recovery/REC-S01_VERIFY.md
- SECTION: S01 recovery — Knowledge Library (active retrieval)
...
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S01_VERIFY)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S01_VERIFY.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S01_VERIFY' evidence/REC-S01_VERIFY.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S01_VERIFY.json?
...
1. State this step id: #REC-S01_VERIFY.
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S01_VERIFY' --classification <SUCCESS|FAILURE>`
