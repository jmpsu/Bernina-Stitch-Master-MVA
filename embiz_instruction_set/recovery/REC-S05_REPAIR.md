# #REC-S05_REPAIR — Recovery: Implement the Repair
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S05_REPAIR
- FILE: recovery/REC-S05_REPAIR.md
- SECTION: S05 recovery — Vector Validation & Ranking
- ON SUCCESS →: #REC-S05_VERIFY @ recovery/REC-S05_VERIFY.md
- ON FAILURE →: #REC-S05_ESCALATE @ recovery/REC-S05_ESCALATE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S05_REPAIR)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S05_REPAIR.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S05_REPAIR' evidence/REC-S05_REPAIR.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S05_REPAIR.json?
...
1. State this step id: #REC-S05_REPAIR.
2. State the SUCCESS route (#REC-S05_VERIFY).
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S05_REPAIR' --classification <SUCCESS|FAILURE>`
