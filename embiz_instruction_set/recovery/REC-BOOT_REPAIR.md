# #REC-BOOT_REPAIR — Recovery: Implement the Repair
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-BOOT_REPAIR
- FILE: recovery/REC-BOOT_REPAIR.md
- SECTION: BOOT recovery — Boot
- ON SUCCESS →: #REC-BOOT_VERIFY @ recovery/REC-BOOT_VERIFY.md
- ON FAILURE →: #REC-BOOT_ESCALATE @ recovery/REC-BOOT_ESCALATE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-BOOT_REPAIR)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-BOOT_REPAIR.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-BOOT_REPAIR' evidence/REC-BOOT_REPAIR.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-BOOT_REPAIR.json?
...
1. State this step id: #REC-BOOT_REPAIR.
2. State the SUCCESS route (#REC-BOOT_VERIFY).
...
10. Run `python3 engine/supervisor.py --resolve '#REC-BOOT_REPAIR' --classification <SUCCESS|FAILURE>`
