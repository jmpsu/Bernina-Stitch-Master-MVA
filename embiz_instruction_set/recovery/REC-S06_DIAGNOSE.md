# #REC-S06_DIAGNOSE — Recovery: Diagnose the Failure
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S06_DIAGNOSE
- FILE: recovery/REC-S06_DIAGNOSE.md
- SECTION: S06 recovery — Embroidery Digitization / Stitch Planning
- ON SUCCESS →: #REC-S06_REPAIR @ recovery/REC-S06_REPAIR.md
- ON FAILURE →: #REC-S06_ESCALATE @ recovery/REC-S06_ESCALATE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S06_DIAGNOSE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S06_DIAGNOSE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S06_DIAGNOSE' evidence/REC-S06_DIAGNOSE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S06_DIAGNOSE.json?
...
1. State this step id: #REC-S06_DIAGNOSE.
2. State the SUCCESS route (#REC-S06_REPAIR).
3. State the FAILURE route: #REC-S06_ESCALATE @ recovery/REC-S06_ESCALATE.md.
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S06_DIAGNOSE' --classification <SUCCESS|FAILURE>`
