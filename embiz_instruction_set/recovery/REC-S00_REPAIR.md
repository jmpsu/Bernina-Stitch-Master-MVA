# #REC-S00_REPAIR — Recovery: Implement the Repair
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S00_REPAIR
- FILE: recovery/REC-S00_REPAIR.md
- SECTION: S00 recovery — Bootstrap Environment
- ON SUCCESS →: #REC-S00_VERIFY @ recovery/REC-S00_VERIFY.md
- ON FAILURE →: #REC-S00_ESCALATE @ recovery/REC-S00_ESCALATE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S00_REPAIR)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S00_REPAIR.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S00_REPAIR' evidence/REC-S00_REPAIR.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S00_REPAIR.json?
...
1. State this step id: #REC-S00_REPAIR.
2. State the SUCCESS route (#REC-S00_VERIFY).
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S00_REPAIR' --classification <SUCCESS|FAILURE>`
