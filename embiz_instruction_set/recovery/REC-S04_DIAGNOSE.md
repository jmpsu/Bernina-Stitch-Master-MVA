# #REC-S04_DIAGNOSE — Recovery: Diagnose the Failure
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S04_DIAGNOSE
- FILE: recovery/REC-S04_DIAGNOSE.md
- SECTION: S04 recovery — I-HIVE Vectorization
- ON SUCCESS →: #REC-S04_REPAIR @ recovery/REC-S04_REPAIR.md
- ON FAILURE →: #REC-S04_ESCALATE @ recovery/REC-S04_ESCALATE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S04_DIAGNOSE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S04_DIAGNOSE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S04_DIAGNOSE' evidence/REC-S04_DIAGNOSE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S04_DIAGNOSE.json?
...
1. State this step id: #REC-S04_DIAGNOSE.
2. State the SUCCESS route (#REC-S04_REPAIR).
3. State the FAILURE route: #REC-S04_ESCALATE @ recovery/REC-S04_ESCALATE.md.
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S04_DIAGNOSE' --classification <SUCCESS|FAILURE>`
