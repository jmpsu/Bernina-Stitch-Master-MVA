# #REC-S13_DIAGNOSE — Recovery: Diagnose the Failure
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S13_DIAGNOSE
- FILE: recovery/REC-S13_DIAGNOSE.md
- SECTION: S13 recovery — Dashboard & Observability
- ON SUCCESS →: #REC-S13_REPAIR @ recovery/REC-S13_REPAIR.md
- ON FAILURE →: #REC-S13_ESCALATE @ recovery/REC-S13_ESCALATE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S13_DIAGNOSE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S13_DIAGNOSE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S13_DIAGNOSE' evidence/REC-S13_DIAGNOSE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S13_DIAGNOSE.json?
...
1. State this step id: #REC-S13_DIAGNOSE.
2. State the SUCCESS route (#REC-S13_REPAIR).
3. State the FAILURE route: #REC-S13_ESCALATE @ recovery/REC-S13_ESCALATE.md.
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S13_DIAGNOSE' --classification <SUCCESS|FAILURE>`
