# #REC-S03_REPAIR — Recovery: Implement the Repair
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S03_REPAIR
- FILE: recovery/REC-S03_REPAIR.md
- SECTION: S03 recovery — Raster Analysis & Cleanup
- ON SUCCESS →: #REC-S03_VERIFY @ recovery/REC-S03_VERIFY.md
- ON FAILURE →: #REC-S03_ESCALATE @ recovery/REC-S03_ESCALATE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S03_REPAIR)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S03_REPAIR.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S03_REPAIR' evidence/REC-S03_REPAIR.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S03_REPAIR.json?
...
1. State this step id: #REC-S03_REPAIR.
2. State the SUCCESS route (#REC-S03_VERIFY).
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S03_REPAIR' --classification <SUCCESS|FAILURE>`
