# #REC-S02_DIAGNOSE — Recovery: Diagnose the Failure
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S02_DIAGNOSE
- FILE: recovery/REC-S02_DIAGNOSE.md
- SECTION: S02 recovery — Customer Intake
- ON SUCCESS →: #REC-S02_REPAIR @ recovery/REC-S02_REPAIR.md
- ON FAILURE →: #REC-S02_ESCALATE @ recovery/REC-S02_ESCALATE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S02_DIAGNOSE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S02_DIAGNOSE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S02_DIAGNOSE' evidence/REC-S02_DIAGNOSE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S02_DIAGNOSE.json?
...
1. State this step id: #REC-S02_DIAGNOSE.
2. State the SUCCESS route (#REC-S02_REPAIR).
3. State the FAILURE route: #REC-S02_ESCALATE @ recovery/REC-S02_ESCALATE.md.
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S02_DIAGNOSE' --classification <SUCCESS|FAILURE>`
