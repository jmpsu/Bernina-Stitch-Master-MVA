# #REC-S04_REPAIR — Recovery: Implement the Repair
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S04_REPAIR
- FILE: recovery/REC-S04_REPAIR.md
- SECTION: S04 recovery — I-HIVE Vectorization
- ON SUCCESS →: #REC-S04_VERIFY @ recovery/REC-S04_VERIFY.md
- ON FAILURE →: #REC-S04_ESCALATE @ recovery/REC-S04_ESCALATE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S04_REPAIR)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S04_REPAIR.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S04_REPAIR' evidence/REC-S04_REPAIR.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S04_REPAIR.json?
...
1. State this step id: #REC-S04_REPAIR.
2. State the SUCCESS route (#REC-S04_VERIFY).
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S04_REPAIR' --classification <SUCCESS|FAILURE>`
