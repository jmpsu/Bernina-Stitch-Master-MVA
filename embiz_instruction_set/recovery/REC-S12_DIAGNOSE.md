# #REC-S12_DIAGNOSE — Recovery: Diagnose the Failure
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S12_DIAGNOSE
- FILE: recovery/REC-S12_DIAGNOSE.md
- SECTION: S12 recovery — Agent Orchestration & Skill Standards
- ON SUCCESS →: #REC-S12_REPAIR @ recovery/REC-S12_REPAIR.md
- ON FAILURE →: #REC-S12_ESCALATE @ recovery/REC-S12_ESCALATE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S12_DIAGNOSE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S12_DIAGNOSE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S12_DIAGNOSE' evidence/REC-S12_DIAGNOSE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S12_DIAGNOSE.json?
...
1. State this step id: #REC-S12_DIAGNOSE.
2. State the SUCCESS route (#REC-S12_REPAIR).
3. State the FAILURE route: #REC-S12_ESCALATE @ recovery/REC-S12_ESCALATE.md.
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S12_DIAGNOSE' --classification <SUCCESS|FAILURE>`
