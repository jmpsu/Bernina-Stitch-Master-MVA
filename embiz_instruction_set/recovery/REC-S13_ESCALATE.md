# #REC-S13_ESCALATE — Recovery: Escalate with Prescribed External Research
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S13_ESCALATE
- FILE: recovery/REC-S13_ESCALATE.md
- SECTION: S13 recovery — Dashboard & Observability
- ON SUCCESS →: #REC-S13_DIAGNOSE @ recovery/REC-S13_DIAGNOSE.md
- ON FAILURE →: #REC-S13_DIAGNOSE @ recovery/REC-S13_DIAGNOSE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S13_ESCALATE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S13_ESCALATE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S13_ESCALATE' evidence/REC-S13_ESCALATE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S13_ESCALATE.json?
...
1. State this step id: #REC-S13_ESCALATE.
2. State the SUCCESS route (#REC-S13_DIAGNOSE).
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S13_ESCALATE' --classification <SUCCESS|FAILURE>`
