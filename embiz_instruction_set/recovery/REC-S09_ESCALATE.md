# #REC-S09_ESCALATE — Recovery: Escalate with Prescribed External Research
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S09_ESCALATE
- FILE: recovery/REC-S09_ESCALATE.md
- SECTION: S09 recovery — Production Tracking & Controls
- ON SUCCESS →: #REC-S09_DIAGNOSE @ recovery/REC-S09_DIAGNOSE.md
- ON FAILURE →: #REC-S09_DIAGNOSE @ recovery/REC-S09_DIAGNOSE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S09_ESCALATE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S09_ESCALATE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S09_ESCALATE' evidence/REC-S09_ESCALATE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S09_ESCALATE.json?
...
1. State this step id: #REC-S09_ESCALATE.
2. State the SUCCESS route (#REC-S09_DIAGNOSE).
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S09_ESCALATE' --classification <SUCCESS|FAILURE>`
