# #REC-S01_ESCALATE — Recovery: Escalate with Prescribed External Research
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S01_ESCALATE
- FILE: recovery/REC-S01_ESCALATE.md
- SECTION: S01 recovery — Knowledge Library (active retrieval)
- ON SUCCESS →: #REC-S01_DIAGNOSE @ recovery/REC-S01_DIAGNOSE.md
- ON FAILURE →: #REC-S01_DIAGNOSE @ recovery/REC-S01_DIAGNOSE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S01_ESCALATE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S01_ESCALATE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S01_ESCALATE' evidence/REC-S01_ESCALATE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S01_ESCALATE.json?
...
1. State this step id: #REC-S01_ESCALATE.
2. State the SUCCESS route (#REC-S01_DIAGNOSE).
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S01_ESCALATE' --classification <SUCCESS|FAILURE>`
