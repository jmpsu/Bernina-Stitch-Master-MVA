# #REC-S03_ESCALATE — Recovery: Escalate with Prescribed External Research
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S03_ESCALATE
- FILE: recovery/REC-S03_ESCALATE.md
- SECTION: S03 recovery — Raster Analysis & Cleanup
- ON SUCCESS →: #REC-S03_DIAGNOSE @ recovery/REC-S03_DIAGNOSE.md
- ON FAILURE →: #REC-S03_DIAGNOSE @ recovery/REC-S03_DIAGNOSE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S03_ESCALATE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S03_ESCALATE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S03_ESCALATE' evidence/REC-S03_ESCALATE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S03_ESCALATE.json?
...
1. State this step id: #REC-S03_ESCALATE.
2. State the SUCCESS route (#REC-S03_DIAGNOSE).
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S03_ESCALATE' --classification <SUCCESS|FAILURE>`
