# #REC-S02_ESCALATE — Recovery: Escalate with Prescribed External Research
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S02_ESCALATE
- FILE: recovery/REC-S02_ESCALATE.md
- SECTION: S02 recovery — Customer Intake
- ON SUCCESS →: #REC-S02_DIAGNOSE @ recovery/REC-S02_DIAGNOSE.md
- ON FAILURE →: #REC-S02_DIAGNOSE @ recovery/REC-S02_DIAGNOSE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S02_ESCALATE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S02_ESCALATE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S02_ESCALATE' evidence/REC-S02_ESCALATE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S02_ESCALATE.json?
...
1. State this step id: #REC-S02_ESCALATE.
2. State the SUCCESS route (#REC-S02_DIAGNOSE).
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S02_ESCALATE' --classification <SUCCESS|FAILURE>`
