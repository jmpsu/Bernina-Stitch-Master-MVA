# #REC-S14_VERIFY — Recovery: Verify the Repair Produced Real Working Behavior
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S14_VERIFY
- FILE: recovery/REC-S14_VERIFY.md
- SECTION: S14 recovery — QA, Historical Learning & Continuous Improvement (never-idle loop)
...
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S14_VERIFY)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S14_VERIFY.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S14_VERIFY' evidence/REC-S14_VERIFY.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S14_VERIFY.json?
...
1. State this step id: #REC-S14_VERIFY.
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S14_VERIFY' --classification <SUCCESS|FAILURE>`
