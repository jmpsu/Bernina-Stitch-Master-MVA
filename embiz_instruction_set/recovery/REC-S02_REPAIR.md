# #REC-S02_REPAIR — Recovery: Implement the Repair
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S02_REPAIR
- FILE: recovery/REC-S02_REPAIR.md
- SECTION: S02 recovery — Customer Intake
- ON SUCCESS →: #REC-S02_VERIFY @ recovery/REC-S02_VERIFY.md
- ON FAILURE →: #REC-S02_ESCALATE @ recovery/REC-S02_ESCALATE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S02_REPAIR)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S02_REPAIR.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S02_REPAIR' evidence/REC-S02_REPAIR.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S02_REPAIR.json?
...
1. State this step id: #REC-S02_REPAIR.
2. State the SUCCESS route (#REC-S02_VERIFY).
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S02_REPAIR' --classification <SUCCESS|FAILURE>`
