# #REC-S00_DIAGNOSE — Recovery: Diagnose the Failure
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S00_DIAGNOSE
- FILE: recovery/REC-S00_DIAGNOSE.md
- SECTION: S00 recovery — Bootstrap Environment
- ON SUCCESS →: #REC-S00_REPAIR @ recovery/REC-S00_REPAIR.md
- ON FAILURE →: #REC-S00_ESCALATE @ recovery/REC-S00_ESCALATE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S00_DIAGNOSE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S00_DIAGNOSE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S00_DIAGNOSE' evidence/REC-S00_DIAGNOSE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S00_DIAGNOSE.json?
...
1. State this step id: #REC-S00_DIAGNOSE.
2. State the SUCCESS route (#REC-S00_REPAIR).
3. State the FAILURE route: #REC-S00_ESCALATE @ recovery/REC-S00_ESCALATE.md.
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S00_DIAGNOSE' --classification <SUCCESS|FAILURE>`
