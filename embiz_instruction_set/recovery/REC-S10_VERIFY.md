# #REC-S10_VERIFY — Recovery: Verify the Repair Produced Real Working Behavior
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S10_VERIFY
- FILE: recovery/REC-S10_VERIFY.md
- SECTION: S10 recovery — Slack Collaboration & Control
...
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S10_VERIFY)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S10_VERIFY.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S10_VERIFY' evidence/REC-S10_VERIFY.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S10_VERIFY.json?
...
1. State this step id: #REC-S10_VERIFY.
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S10_VERIFY' --classification <SUCCESS|FAILURE>`
