# #REC-S14_ESCALATE — Recovery: Escalate with Prescribed External Research
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S14_ESCALATE
- FILE: recovery/REC-S14_ESCALATE.md
- SECTION: S14 recovery — QA, Historical Learning & Continuous Improvement (never-idle loop)
- ON SUCCESS →: #REC-S14_DIAGNOSE @ recovery/REC-S14_DIAGNOSE.md
- ON FAILURE →: #REC-S14_DIAGNOSE @ recovery/REC-S14_DIAGNOSE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S14_ESCALATE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S14_ESCALATE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S14_ESCALATE' evidence/REC-S14_ESCALATE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S14_ESCALATE.json?
...
1. State this step id: #REC-S14_ESCALATE.
2. State the SUCCESS route (#REC-S14_DIAGNOSE).
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S14_ESCALATE' --classification <SUCCESS|FAILURE>`
