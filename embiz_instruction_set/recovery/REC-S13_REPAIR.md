# #REC-S13_REPAIR — Recovery: Implement the Repair
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S13_REPAIR
- FILE: recovery/REC-S13_REPAIR.md
- SECTION: S13 recovery — Dashboard & Observability
- ON SUCCESS →: #REC-S13_VERIFY @ recovery/REC-S13_VERIFY.md
- ON FAILURE →: #REC-S13_ESCALATE @ recovery/REC-S13_ESCALATE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S13_REPAIR)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S13_REPAIR.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S13_REPAIR' evidence/REC-S13_REPAIR.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S13_REPAIR.json?
...
1. State this step id: #REC-S13_REPAIR.
2. State the SUCCESS route (#REC-S13_VERIFY).
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S13_REPAIR' --classification <SUCCESS|FAILURE>`
