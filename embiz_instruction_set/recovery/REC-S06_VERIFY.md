# #REC-S06_VERIFY — Recovery: Verify the Repair Produced Real Working Behavior
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S06_VERIFY
- FILE: recovery/REC-S06_VERIFY.md
- SECTION: S06 recovery — Embroidery Digitization / Stitch Planning
...
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S06_VERIFY)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S06_VERIFY.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S06_VERIFY' evidence/REC-S06_VERIFY.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S06_VERIFY.json?
...
1. State this step id: #REC-S06_VERIFY.
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S06_VERIFY' --classification <SUCCESS|FAILURE>`
