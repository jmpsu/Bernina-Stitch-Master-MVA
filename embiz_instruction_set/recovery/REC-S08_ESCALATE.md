# #REC-S08_ESCALATE — Recovery: Escalate with Prescribed External Research
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S08_ESCALATE
- FILE: recovery/REC-S08_ESCALATE.md
- SECTION: S08 recovery — Production Export
- ON SUCCESS →: #REC-S08_DIAGNOSE @ recovery/REC-S08_DIAGNOSE.md
- ON FAILURE →: #REC-S08_DIAGNOSE @ recovery/REC-S08_DIAGNOSE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S08_ESCALATE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S08_ESCALATE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S08_ESCALATE' evidence/REC-S08_ESCALATE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S08_ESCALATE.json?
...
1. State this step id: #REC-S08_ESCALATE.
2. State the SUCCESS route (#REC-S08_DIAGNOSE).
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S08_ESCALATE' --classification <SUCCESS|FAILURE>`
