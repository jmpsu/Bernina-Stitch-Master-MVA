# #REC-S11_DIAGNOSE — Recovery: Diagnose the Failure
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S11_DIAGNOSE
- FILE: recovery/REC-S11_DIAGNOSE.md
- SECTION: S11 recovery — Infrastructure & Multi-Cloud
- ON SUCCESS →: #REC-S11_REPAIR @ recovery/REC-S11_REPAIR.md
- ON FAILURE →: #REC-S11_ESCALATE @ recovery/REC-S11_ESCALATE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S11_DIAGNOSE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S11_DIAGNOSE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S11_DIAGNOSE' evidence/REC-S11_DIAGNOSE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S11_DIAGNOSE.json?
...
1. State this step id: #REC-S11_DIAGNOSE.
2. State the SUCCESS route (#REC-S11_REPAIR).
3. State the FAILURE route: #REC-S11_ESCALATE @ recovery/REC-S11_ESCALATE.md.
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S11_DIAGNOSE' --classification <SUCCESS|FAILURE>`
