# #REC-S07_ESCALATE — Recovery: Escalate with Prescribed External Research
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S07_ESCALATE
- FILE: recovery/REC-S07_ESCALATE.md
- SECTION: S07 recovery — Stitch Validation, Simulation & Compliance
- ON SUCCESS →: #REC-S07_DIAGNOSE @ recovery/REC-S07_DIAGNOSE.md
- ON FAILURE →: #REC-S07_DIAGNOSE @ recovery/REC-S07_DIAGNOSE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S07_ESCALATE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S07_ESCALATE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S07_ESCALATE' evidence/REC-S07_ESCALATE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S07_ESCALATE.json?
...
1. State this step id: #REC-S07_ESCALATE.
2. State the SUCCESS route (#REC-S07_DIAGNOSE).
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S07_ESCALATE' --classification <SUCCESS|FAILURE>`
