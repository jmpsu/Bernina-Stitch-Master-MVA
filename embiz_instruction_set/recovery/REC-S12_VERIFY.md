# #REC-S12_VERIFY — Recovery: Verify the Repair Produced Real Working Behavior
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S12_VERIFY
- FILE: recovery/REC-S12_VERIFY.md
- SECTION: S12 recovery — Agent Orchestration & Skill Standards
...
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S12_VERIFY)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S12_VERIFY.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S12_VERIFY' evidence/REC-S12_VERIFY.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S12_VERIFY.json?
...
1. State this step id: #REC-S12_VERIFY.
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S12_VERIFY' --classification <SUCCESS|FAILURE>`
