# #REC-S03_DIAGNOSE — Recovery: Diagnose the Failure
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S03_DIAGNOSE
- FILE: recovery/REC-S03_DIAGNOSE.md
- SECTION: S03 recovery — Raster Analysis & Cleanup
- ON SUCCESS →: #REC-S03_REPAIR @ recovery/REC-S03_REPAIR.md
- ON FAILURE →: #REC-S03_ESCALATE @ recovery/REC-S03_ESCALATE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S03_DIAGNOSE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S03_DIAGNOSE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S03_DIAGNOSE' evidence/REC-S03_DIAGNOSE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S03_DIAGNOSE.json?
...
1. State this step id: #REC-S03_DIAGNOSE.
2. State the SUCCESS route (#REC-S03_REPAIR).
3. State the FAILURE route: #REC-S03_ESCALATE @ recovery/REC-S03_ESCALATE.md.
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S03_DIAGNOSE' --classification <SUCCESS|FAILURE>`
