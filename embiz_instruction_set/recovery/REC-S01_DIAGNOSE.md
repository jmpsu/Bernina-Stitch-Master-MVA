# #REC-S01_DIAGNOSE — Recovery: Diagnose the Failure
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S01_DIAGNOSE
- FILE: recovery/REC-S01_DIAGNOSE.md
- SECTION: S01 recovery — Knowledge Library (active retrieval)
- ON SUCCESS →: #REC-S01_REPAIR @ recovery/REC-S01_REPAIR.md
- ON FAILURE →: #REC-S01_ESCALATE @ recovery/REC-S01_ESCALATE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S01_DIAGNOSE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S01_DIAGNOSE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S01_DIAGNOSE' evidence/REC-S01_DIAGNOSE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S01_DIAGNOSE.json?
...
1. State this step id: #REC-S01_DIAGNOSE.
2. State the SUCCESS route (#REC-S01_REPAIR).
3. State the FAILURE route: #REC-S01_ESCALATE @ recovery/REC-S01_ESCALATE.md.
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S01_DIAGNOSE' --classification <SUCCESS|FAILURE>`
