# #REC-S14_DIAGNOSE — Recovery: Diagnose the Failure
<!-- generated by engine/generate_steps.py — do not hand-edit; edit DATA and regenerate. -->

## ROUTING HEADER
- STEP: #REC-S14_DIAGNOSE
- FILE: recovery/REC-S14_DIAGNOSE.md
- SECTION: S14 recovery — QA, Historical Learning & Continuous Improvement (never-idle loop)
- ON SUCCESS →: #REC-S14_REPAIR @ recovery/REC-S14_REPAIR.md
- ON FAILURE →: #REC-S14_ESCALATE @ recovery/REC-S14_ESCALATE.md
- ATTEMPT LEDGER: state/attempts.jsonl (key = #REC-S14_DIAGNOSE)
...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S14_DIAGNOSE.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S14_DIAGNOSE' evidence/REC-S14_DIAGNOSE.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S14_DIAGNOSE.json?
...
1. State this step id: #REC-S14_DIAGNOSE.
2. State the SUCCESS route (#REC-S14_REPAIR).
3. State the FAILURE route: #REC-S14_ESCALATE @ recovery/REC-S14_ESCALATE.md.
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S14_DIAGNOSE' --classification <SUCCESS|FAILURE>`
