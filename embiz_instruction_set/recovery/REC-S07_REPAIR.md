...
## EVIDENCE TO PRODUCE
- WRITE: evidence/REC-S07_REPAIR.json
...
- HASH: `python3 engine/hash_chain.py --append '#REC-S07_REPAIR' evidence/REC-S07_REPAIR.json <SUCCESS|FAILURE>`
...
- Q1 (mandatory): Was a hash-tagged evidence file saved to evidence/REC-S07_REPAIR.json?
...
1. State this step id: #REC-S07_REPAIR.
2. State the SUCCESS route (#REC-S07_VERIFY).
...
10. Run `python3 engine/supervisor.py --resolve '#REC-S07_REPAIR' --classification <SUCCESS|FAILURE>`
