---
name: embiz-frontend-ui-engineering
description: EMBIZ-adapted version of frontend-ui-engineering. Use only inside the embroidery business agent system with approval gates, evidence checks, no fake artifact claims, backups, and job-state safety.
---

# EMBIZ Adapted Skill: frontend-ui-engineering
