---
name: embiz-security-and-hardening
description: EMBIZ-adapted version of security-and-hardening. Use only inside the embroidery business agent system with approval gates, evidence checks, no fake artifact claims, backups, and job-state safety.
---

# EMBIZ Adapted Skill: security-and-hardening
