---
name: embiz-doubt-driven-development
description: EMBIZ-adapted version of doubt-driven-development. Use only inside the embroidery business agent system with approval gates, evidence checks, no fake artifact claims, backups, and job-state safety.
---

# EMBIZ Adapted Skill: doubt-driven-development
