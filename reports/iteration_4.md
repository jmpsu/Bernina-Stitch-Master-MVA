...
- Timestamp: `2026-07-04T06:32:20.361162+00:00`
- Artifacts measured: **8**
- **OVERALL_SCORE: 0.5810**
...
| performance | 0.8999 | 0.10 | 0.1000 | 1 - median_total_runtime(0.2001s)/budget(2.0s) over 5 runs [min=0.1978s median=0.2001s p95=0.2078s] |
...
DUAL-BASIS reporting. (a) overall_score=0.581012 is the NEW full-weight score including visual_similarity at its real weight 0.40 - this is the honest current score now that all five dimensions are measurable. (b) overall_score_continuity_4metric=0.516432 drops visual and renormalizes over the same 4 metrics as iterations 1-3, so it is directly comparable to iteration 3's 0.5127. Comparing (a) to 0.5127 would be confounded by reintroducing the 0.40 weight; use (b) for a clean iteration-over-iteration delta.

- OVERALL_SCORE (full-weight, visual 0.40 included): **0.581012**
- OVERALL (continuity, 4-metric renorm, visual dropped, same basis as iterations 1-3): **0.516432**
...
|---|---|---|---|---|
| 5 | 0.197763 | 0.200148 | 0.207843 | 0.201894, 0.200148, 0.197763, 0.209330, 0.199065 |

## Comparison vs iteration 3 (Phase 6)

- Previous OVERALL_SCORE (4-metric renorm basis): **0.512722**
- Current OVERALL_SCORE (full-weight, visual 0.40): **0.581012**
- Current OVERALL (continuity, 4-metric renorm, same basis as previous): **0.516432**
- **Apples-to-apples continuity delta (4-metric): +0.003710** (improved)
- Full-weight 'delta' (CONFOUNDED by the 0.40 weight reintroduction, not a clean comparison): +0.068290

BASIS CHANGE: iteration 4 reintroduces visual_similarity at weight 0.40, so the primary OVERALL_SCORE (0.581012) is on a NEW full-weight basis and is NOT directly comparable to the previous 4-metric score 0.512722. The apples-to-apples continuity delta (4-metric, visual dropped) is +0.003710; the full-weight 'delta' +0.068290 is confounded by the weight change and is reported only for completeness.
...
| performance | 0.877671 | 0.899926 | +0.022255 |
| code_reliability | 1.000000 | 1.000000 | +0.000000 |

### vs iteration 1 baseline

- Baseline (iteration 1) OVERALL_SCORE: **0.514432**
- Current OVERALL_SCORE: **0.581012**
- Delta vs baseline: **+0.066580** (above baseline)

## SVG metrics

| File | valid | paths | nodes | groups | elements | bytes | runtime_s |
|---|---|---|---|---|---|---|---|
| coastal_objects_all.svg | True | 21 | 53653 | 2 | 30 | 1002190 | 0.017846 |
| drink_trace.svg | True | 21 | 271 | 2 | 35 | 21674 | 0.000504 |
| drink_v2.svg | True | 6 | 99 | 2 | 19 | 16472 | 0.000305 |

## PES metrics

| File | valid | stitches | trims | colors | W mm | H mm | avg st mm | p50 mm | p95 mm | short% | long% | safe% | trims/1k | density/cm2 (info) | runtime_s |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| basket_7scans.pes | True | 11359 | 94 | 6 | 30.4 | 29.0 | 1.0887 | 0.7 | 3.0 | 0.3018 | 0.0 | 0.6982 | 8.2754 | 1288.453 | 0.017227 |
| basket_small.pes | True | 6597 | 102 | 13 | 30.2 | 28.8 | 0.8023 | 0.5 | 2.0 | 0.4429 | 0.0 | 0.5571 | 15.4616 | 758.485 | 0.009601 |
| drink.pes | True | 4736 | 6 | 6 | 12.4 | 23.8 | 0.883 | 0.4243 | 2.8 | 0.5113 | 0.0 | 0.4887 | 1.2669 | 1604.771 | 0.006657 |
| drink_v2.pes | True | 1561 | 5 | 6 | 12.2 | 23.8 | 0.7788 | 0.4243 | 2.3022 | 0.5235 | 0.0 | 0.4765 | 3.2031 | 537.608 | 0.002334 |
| summer_coastal-icons.pes | True | 88710 | 645 | 21 | 371.6 | 68.0 | 1.2781 | 0.7 | 3.0 | 0.377 | 0.0 | 0.623 | 7.2709 | 351.065 | 0.144557 |
